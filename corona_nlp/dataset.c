...
{
    "distutils": {
        "name": "corona_nlp.dataset",
        "sources": [
            "corona_nlp/dataset.pyx"
        ]
    },
    "module_name": "corona_nlp.dataset"
}
END: Cython Metadata */
...
#define __PYX_HAVE__corona_nlp__dataset
#define __PYX_HAVE_API__corona_nlp__dataset
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Implementation of 'corona_nlp.dataset' */
...
static PyObject *__pyx_n_s_corona_nlp_dataset;
static PyObject *__pyx_kp_s_corona_nlp_dataset_pyx;
...
static PyObject *__pyx_n_s_load_paper;
static PyObject *__pyx_n_s_load_papers;
...
static PyObject *__pyx_n_s_normalize_whitespace;
static PyObject *__pyx_n_s_num_papers;
...
/* Python wrapper */
static PyObject *__pyx_pw_10corona_nlp_7dataset_13CORD19Dataset_1__init__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
static PyObject *__pyx_pw_10corona_nlp_7dataset_13CORD19Dataset_7title(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_self,&__pyx_n_s_index,&__pyx_n_s_paper_id,0};
    PyObject* values[3] = {0,0,0};
    values[1] = ((PyObject *)((PyObject *)Py_None));
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  2:
        if (kw_args > 0) {
          PyObject* value = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_paper_id);
          if (value) { values[2] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
    ...
    __pyx_v_paper_id = ((PyObject*)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyObject *__pyx_pf_10corona_nlp_7dataset_13CORD19Dataset_8titles(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_indices, PyObject *__pyx_v_paper_ids) {
  ...
  __pyx_cur_scope = (struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *)__pyx_tp_new_10corona_nlp_7dataset___pyx_scope_struct__titles(__pyx_ptype_10corona_nlp_7dataset___pyx_scope_struct__titles, __pyx_empty_tuple, NULL);
...
static struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *__pyx_freelist_10corona_nlp_7dataset___pyx_scope_struct__titles[8];
static int __pyx_freecount_10corona_nlp_7dataset___pyx_scope_struct__titles = 0;

static PyObject *__pyx_tp_new_10corona_nlp_7dataset___pyx_scope_struct__titles(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  PyObject *o;
  if (CYTHON_COMPILING_IN_CPYTHON && likely((__pyx_freecount_10corona_nlp_7dataset___pyx_scope_struct__titles > 0) & (t->tp_basicsize == sizeof(struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles)))) {
    o = (PyObject*)__pyx_freelist_10corona_nlp_7dataset___pyx_scope_struct__titles[--__pyx_freecount_10corona_nlp_7dataset___pyx_scope_struct__titles];
    memset(o, 0, sizeof(struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles));
...
static void __pyx_tp_dealloc_10corona_nlp_7dataset___pyx_scope_struct__titles(PyObject *o) {
  struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *p = (struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *)o;
  ...
  if (CYTHON_COMPILING_IN_CPYTHON && ((__pyx_freecount_10corona_nlp_7dataset___pyx_scope_struct__titles < 8) & (Py_TYPE(o)->tp_basicsize == sizeof(struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles)))) {
    __pyx_freelist_10corona_nlp_7dataset___pyx_scope_struct__titles[__pyx_freecount_10corona_nlp_7dataset___pyx_scope_struct__titles++] = ((struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *)o);
  } else {
    (*Py_TYPE(o)->tp_free)(o);
  }
}

static int __pyx_tp_traverse_10corona_nlp_7dataset___pyx_scope_struct__titles(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *p = (struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles *)o;
...
static PyTypeObject __pyx_type_10corona_nlp_7dataset___pyx_scope_struct__titles = {
  PyVarObject_HEAD_INIT(0, 0)
  "corona_nlp.dataset.__pyx_scope_struct__titles", /*tp_name*/
  sizeof(struct __pyx_obj_10corona_nlp_7dataset___pyx_scope_struct__titles), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_10corona_nlp_7dataset___pyx_scope_struct__titles, /*tp_dealloc*/
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_10corona_nlp_7dataset___pyx_scope_struct__titles, /*tp_traverse*/
  0, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_10corona_nlp_7dataset___pyx_scope_struct__titles, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_corona_nlp_dataset, __pyx_k_corona_nlp_dataset, sizeof(__pyx_k_corona_nlp_dataset), 0, 0, 1, 1},
  {&__pyx_kp_s_corona_nlp_dataset_pyx, __pyx_k_corona_nlp_dataset_pyx, sizeof(__pyx_k_corona_nlp_dataset_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_load_paper, __pyx_k_load_paper, sizeof(__pyx_k_load_paper), 0, 0, 1, 1},
  {&__pyx_n_s_load_papers, __pyx_k_load_papers, sizeof(__pyx_k_load_papers), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_normalize_whitespace, __pyx_k_normalize_whitespace, sizeof(__pyx_k_normalize_whitespace), 0, 0, 1, 1},
  {&__pyx_n_s_num_papers, __pyx_k_num_papers, sizeof(__pyx_k_num_papers), 0, 0, 1, 1},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_10corona_nlp_7dataset___pyx_scope_struct__titles.tp_dictoffset && __pyx_type_10corona_nlp_7dataset___pyx_scope_struct__titles.tp_getattro == PyObject_GenericGetAttr)) {
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_corona_nlp__dataset) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "corona_nlp.dataset")) {
      if (unlikely(PyDict_SetItemString(modules, "corona_nlp.dataset", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_normalize_whitespace, __pyx_t_1) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init corona_nlp.dataset", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init corona_nlp.dataset");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
